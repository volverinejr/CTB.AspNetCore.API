...
{
    public class InfracaoInsertCommand : Notifiable, ICommand
    {
        ...
        public void Validate()
        {
            ...
            AddNotifications(
                new Contract()
                    ...
                    .IsNotNullOrWhiteSpace(Codigo, "Codigo", "Codigo deve ser preenchido.")
                    .HasLen(Codigo, 5, "Codigo", "Codigo deve ter 5 caracteres")

                    .IsNotNullOrWhiteSpace(Descricao, "Descricao", "Descricao deve ser preenchido.")
                    ...
                    .IsNotNullOrWhiteSpace(AmparoLegal, "AmparoLegal", "AmparoLegal deve ser preenchido.")
